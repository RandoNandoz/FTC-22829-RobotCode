...
@TeleOp(name = "DbgMecanumDriveRandy")
@Disabled
public class DbgMecanumDriveRandy extends LinearOpMode {
...
//            telemetry.addData("Back Right Motor Encoder Ticks: ", String.format(Locale.CANADA, "%d ticks", mBackRight.getCurrentPosition()));
            ...
            mecanumDrive.driveRobotCentric(-driverOp.getLeftX() * 0.85, -driverOp.getLeftY() * 0.85, -driverOp.getRightX() * 0.85, true);
            ...
            double slidePower = operatorOp.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER) - operatorOp.getTrigger(GamepadKeys.Trigger.LEFT_TRIGGER);
...
//            if (operatorOp.getButton(GamepadKeys.Button.LEFT_BUMPER)) {
//                claw.close();
//            } else if (operatorOp.getButton(GamepadKeys.Button.RIGHT_BUMPER)) {
//                claw.open();
//            }

            if (operatorOp.getButton(GamepadKeys.Button.RIGHT_BUMPER)) {
                sClaw.rotateByAngle(2);
            } else if (operatorOp.getButton(GamepadKeys.Button.LEFT_BUMPER)) {
                sClaw.rotateByAngle(-2);
            }
